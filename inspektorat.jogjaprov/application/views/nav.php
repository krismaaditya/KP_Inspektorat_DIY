  ...
  <body>
    ...
    <nav class="navbar" id="mainNavbar">
      <ul>
        ...
        <li class="left-li"><a class="main-a" href="">Gallery</a></li>
        ...
        if (!$id_user) { ?>
          ...
          <li class="loginbutton"><button id="loginBtn">Log In</button>
            <!-- LOGIN MODAL -->
          ...
          <li class="registerbutton"><button id="registerBtn">Register</button>
            <!-- REGISTER MODAL -->
              ...
              <div class="registerModal-content">
                ...
                <div class="registerModal-body">
                  <form role="form" class="registerform" action="<?php echo base_url('user/daftar'); ?>" method="post">
                    ...
                    <input class="loginButton" id="regsubmit" type="submit" name="submit" value="Daftar">
                  </form>
                </div>
        ...
        <?php } else { ?>
          <li class="user-dropdown-container">
            <a class="user-button" onclick="userMenu()"><?php echo $this->session->userdata('nama_user'); ?></a>
            <div class="user-dropdown-content" id="userDropdown">
              <a class="user-sub-menu-link" href="<?php echo base_url('user/profile'); ?>">Halaman Profil</a>
          ...
          <a class="search-dropdown-button" onclick="searchMenu()">
            ...
            <div class="search-dropdown-content" id="searchDropdown">
              <form class="search-form" action="" method="post">
                <input class="searchbar" type="text" name="search" placeholder="Cari..">
